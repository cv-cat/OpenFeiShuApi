...
class FlyBookApi:
    send_msg_url = "https://internal-api-lark-api.feishu.cn/im/gateway/"
    def send_msg(self, auth, sends_text, chatId):
        ...
        response = requests.post(self.send_msg_url, headers=headers, cookies=auth.cookie, data=Packet.SerializeToString(), verify=False)
